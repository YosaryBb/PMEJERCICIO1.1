package com.example.pmejercicio11;
...
import com.example.pmejercicio11.claseMatematica.Matematicas;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onClickSuma(View view){
        if(!emptyField(value1, value2)){
            Matematicas mt = new Matematicas(Integer.parseInt(value1.getText().toString()), Integer.parseInt(value2.getText().toString()));
